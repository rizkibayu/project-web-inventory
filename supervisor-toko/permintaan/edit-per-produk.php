...
INNER JOIN produk ON permintaan.id_item = produk.id_produk
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="nama_produk" value="<?php echo $tampil['nama_produk'] ?>" required="" readonly>
	</div>
    <div class="form-group">
	...
	<a href="menu.php?halaman=detail-per-produk&id=<?php echo $tampil['po_item'] ?>" class="btn btn-warning">KEMBALI</a>