...
<input type="hidden" class="form-control" required="" value="<?php echo $tampil['kategori'] ?>" name="kategori">
        ...
        <div class="col-lg-12">
            <table class="table" style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" class="form-control" required="" max="<?php echo $tampil['stok'] ?>" value="<?php echo $tampil['retur_kuantitas'] ?>" name="retur_kuantitas">
                    </td>
                </tr>
            </table>
    ...
    <div>
        <div class="col-lg-12">
            <button class="btn btn-success" type="submit" name="save">SIMPAN PERUBAHAN</button>&nbsp;<a href="menu.php?halaman=barang-retur" class="btn btn-warning">KEMBALI</a>
        </div>
    </div>
</form>
</div>