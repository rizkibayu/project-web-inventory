...
<div class="main-content">
	<section class="container-fluid">
		...
		if (isset($_GET['halaman'])) {
			...
			} elseif ($_GET['halaman'] == "approve-barang-retur") {
				include 'retur/approve-barang-retur.php';					
			} elseif ($_GET['halaman'] == "cancel-barang-retur") {
				include 'retur/cancel-barang-retur.php';					
			} elseif ($_GET['halaman'] == "approve-produk-retur") {
				include 'retur/approve-produk-retur.php';					
			} elseif ($_GET['halaman'] == "cancel-produk-retur") {
				include 'retur/cancel-produk-retur.php';					
			} 
		} else {
