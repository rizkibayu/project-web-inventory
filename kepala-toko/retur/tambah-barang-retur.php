...
if (isset($_POST['save'])) {
    ...
    if ($retur_kuantitas > $max) {
        ...
        $koneksi->query("INSERT INTO retur (po_retur,id_item, stok_before_retur, retur_kuantitas, retur_tanggal, retur_keterangan, kategori, status_retur) VALUES ('$po_retur','$id_item','$stok_before_retur','$retur_kuantitas','$retur_tanggal','$retur_keterangan','Barang Keperluan Toko','Waiting For Approval')");
